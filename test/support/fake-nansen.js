// TEST FIXTURE ONLY: a fake Nansen client serving synthetic data in the exact
// response shapes of the real API, so tests exercise the full scan pipeline
// without a key or network. Never imported by the app.

export const FAKE_TOKEN = "0x00000000000000000000000000000000000000f1";
export const FAKE_META = { name: "Fixture Token", symbol: "FIX", chain: "ethereum", address: FAKE_TOKEN };
...
export class FakeNansenClient {
  ...
  async post(endpoint, body) {
    ...
    switch (endpoint) {
      case "search/general":
        res = { tokens: [{ name: FAKE_META.name, symbol: FAKE_META.symbol, chain: "ethereum", address: FAKE_TOKEN, market_cap: 420_000_000 }] };
        break;
      case "tgm/holders":
      ...
      case "profiler/address/related-wallets":
        ...
        break;
      default:
        throw new Error(`fake-nansen: unsupported endpoint ${endpoint}`);
    }
