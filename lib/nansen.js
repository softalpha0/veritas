...
export const api = {
  ...
  tokenScreener: (c, chain, { timeframe = "24h", orderBy = "volume", smartMoney = false, page = 1, perPage = 50 } = {}) =>
    c.post(
      "token-screener",
      {
        chains: [chain],
        timeframe,
        filters: { include_stablecoins: false, include_native_tokens: false, ...(smartMoney ? { trader_type: "sm" } : {}) },
